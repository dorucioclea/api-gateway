...
ALTER TABLE managed_applications ALTER COLUMN api_key DROP NOT NULL;
ALTER TABLE contracts ALTER COLUMN apikey DROP NOT NULL;
...
UPDATE application_versions SET apikey = contracts.apikey FROM contracts WHERE contracts.appv_id = application_versions.id;
