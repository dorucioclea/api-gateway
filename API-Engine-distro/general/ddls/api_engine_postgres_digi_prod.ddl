...
INSERT INTO gateways (id, configuration,endpoint, created_by, created_on, description, modified_by, modified_on, name, type) VALUES ('KongGateway', '{"endpoint":"https://api-gwadmin-p.antwerpen.be","username":"","password":""}','https://api-gw-p.antwerpen.be', '', CURRENT_DATE, 'This is the gateway.', '', CURRENT_DATE, 'Default Kong Gateway', 'REST', '/secure/oauth2/authorize', '/secure/oauth2/token');
