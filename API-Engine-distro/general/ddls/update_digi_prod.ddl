...
ALTER TABLE public.managed_applications DROP CONSTRAINT fk_manap_available_code;
ALTER TABLE public.managed_applications DROP CONSTRAINT fk_manapp_gateway_id;
