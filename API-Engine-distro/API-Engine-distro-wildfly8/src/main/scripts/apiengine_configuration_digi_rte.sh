...
curl -X POST http://rasu076.rte.antwerpen.local:8001/consumers/rte.marketplace.v1/keyauth \
...
curl -X POST http://rasu076.rte.antwerpen.local:8001/consumers/rte.publisher.v1/keyauth \
    --data "key=***REMOVED***"
