package com.t1t.digipolis.apim.core.plugin;

import com.t1t.digipolis.apim.common.plugin.*;
...
public abstract class AbstractPluginRegistry implements IPluginRegistry {
    ...
    /**
     * @see com.t1t.digipolis.apim.core.IPluginRegistry#loadPlugin(PluginCoordinates)
     */
    @Override
