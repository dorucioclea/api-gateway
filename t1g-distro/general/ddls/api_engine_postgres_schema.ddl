...
ALTER TABLE managed_applications
  ADD PRIMARY KEY (id);

ALTER TABLE memberships
  ADD PRIMARY KEY (id);

ALTER TABLE operating_modes
  ADD PRIMARY KEY (id);
...
ALTER TABLE svc_visibility
  ADD PRIMARY KEY (service_version_id, code);
...
CREATE INDEX idx_fk_categories_1
  ON categories (servicebean_id, servicebean_organization_id);

CREATE INDEX idx_fk_contracts_1
  ON contracts (appv_id);

CREATE INDEX idx_fk_contracts_2
  ON contracts (planv_id);

CREATE INDEX idx_fk_contracts_3
  ON contracts (svcv_id);

CREATE INDEX idx_fk_followers_1
...
CREATE INDEX idx_fk_oauth_scopes_1
...
ALTER TABLE app_oauth_redirect_uris
  ADD CONSTRAINT uk_app_oauth_redirect_uris UNIQUE (application_version_id, oauth_client_redirect);

ALTER TABLE application_versions
  ADD CONSTRAINT uk_app_versions_1 UNIQUE (app_id, app_org_id, version);

ALTER TABLE brandings
  ADD CONSTRAINT uk_brandings_1 UNIQUE (name);

ALTER TABLE contracts
  ADD CONSTRAINT uk_contracts_1 UNIQUE (appv_id, svcv_id, planv_id);

ALTER TABLE events
  ADD CONSTRAINT uk_events_1 UNIQUE (origin_id, destination_id, type);

ALTER TABLE managed_application_keys
  ADD CONSTRAINT uk_managed_app_keys_1 UNIQUE (managed_app_id, api_key);

ALTER TABLE managed_applications
  ADD CONSTRAINT uk_managedapp_1 UNIQUE (prefix);
...
ALTER TABLE service_basepaths
  ADD CONSTRAINT uk_service_basepaths_1 UNIQUE (servicebean_organization_id, servicebean_id, basepath);

ALTER TABLE service_brandings
  ADD CONSTRAINT uk_service_brandings_1 UNIQUE (service_id, branding_id);

ALTER TABLE service_defs
  ADD CONSTRAINT uk_service_defs_1 UNIQUE (service_version_id);

ALTER TABLE service_hosts
  ADD CONSTRAINT uk_service_hosts_1 UNIQUE (service_version_id, hostname);
...
ALTER TABLE application_versions
  ADD CONSTRAINT fk_application_versions_1 FOREIGN KEY (app_id, app_org_id) REFERENCES applications (id, organization_id);

ALTER TABLE app_oauth_redirect_uris
  ADD CONSTRAINT fk_app_oauth_redirect_uris_1 FOREIGN KEY (application_version_id) REFERENCES application_versions (id);

ALTER TABLE applications
  ADD CONSTRAINT fk_applications_1 FOREIGN KEY (organization_id) REFERENCES organizations (id);

ALTER TABLE categories
  ADD CONSTRAINT fk_categories_1 FOREIGN KEY (servicebean_id, servicebean_organization_id) REFERENCES services (id, organization_id);

ALTER TABLE contracts
  ADD CONSTRAINT fk_contracts_1 FOREIGN KEY (appv_id) REFERENCES application_versions (id);

ALTER TABLE contracts
  ADD CONSTRAINT fk_contracts_2 FOREIGN KEY (planv_id) REFERENCES plan_versions (id);

ALTER TABLE contracts
  ADD CONSTRAINT fk_contracts_3 FOREIGN KEY (svcv_id) REFERENCES service_versions (id);

ALTER TABLE endpoint_properties
  ADD CONSTRAINT fk_endpoint_properties_1 FOREIGN KEY (service_version_id) REFERENCES service_versions (id);

ALTER TABLE followers
  ADD CONSTRAINT fk_followers_1 FOREIGN KEY (servicebean_id, servicebean_organization_id) REFERENCES services (id, organization_id);

ALTER TABLE managed_application_keys
  ADD CONSTRAINT fk_managed_app_keys_1 FOREIGN KEY (managed_app_id) REFERENCES managed_applications (id);

ALTER TABLE oauth_scopes
  ADD CONSTRAINT fk_oauth_scopes_1 FOREIGN KEY (serviceversionbean_id) REFERENCES service_versions (id);

ALTER TABLE permissions
  ADD CONSTRAINT fk_permissions_1 FOREIGN KEY (role_id) REFERENCES roles (id);

ALTER TABLE plan_versions
  ADD CONSTRAINT fk_plan_versions_1 FOREIGN KEY (plan_id, plan_org_id) REFERENCES plans (id, organization_id);

ALTER TABLE plans
  ADD CONSTRAINT fk_plans_1 FOREIGN KEY (organization_id) REFERENCES organizations (id);

ALTER TABLE policies
  ADD CONSTRAINT fk_policies_1 FOREIGN KEY (definition_id) REFERENCES policydefs (id);

ALTER TABLE service_basepaths
  ADD CONSTRAINT fk_service_basepaths_1 FOREIGN KEY (servicebean_organization_id, servicebean_id) REFERENCES services (organization_id, id);

ALTER TABLE service_brandings
  ADD CONSTRAINT fk_service_brandings_1 FOREIGN KEY (service_id, organization_id) REFERENCES services (id, organization_id);

ALTER TABLE service_brandings
  ADD CONSTRAINT fk_service_brandings_2 FOREIGN KEY (branding_id) REFERENCES brandings (id);

ALTER TABLE service_defs
  ADD CONSTRAINT fk_service_defs_1 FOREIGN KEY (service_version_id) REFERENCES service_versions (id);

ALTER TABLE service_hosts
  ADD CONSTRAINT fk_service_hosts_1 FOREIGN KEY (service_version_id) REFERENCES service_versions (id);

ALTER TABLE service_versions
  ADD CONSTRAINT fk_service_versions_1 FOREIGN KEY (service_id, service_org_id) REFERENCES services (id, organization_id);

ALTER TABLE services
  ADD CONSTRAINT fk_services_1 FOREIGN KEY (organization_id) REFERENCES organizations (id);

ALTER TABLE svc_gateways
  ADD CONSTRAINT fk_svc_gateways_1 FOREIGN KEY (service_version_id) REFERENCES service_versions (id);

ALTER TABLE svc_plans
  ADD CONSTRAINT fk_scv_plans_1 FOREIGN KEY (service_version_id) REFERENCES service_versions (id);

ALTER TABLE svc_visibility
  ADD CONSTRAINT fk_svc_visibility_1 FOREIGN KEY (service_version_id) REFERENCES service_versions (id);
