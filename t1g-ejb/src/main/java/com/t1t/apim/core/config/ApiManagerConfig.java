package com.t1t.apim.core.config;

import com.t1t.apim.common.config.ConfigFactory;
...
public class ApiManagerConfig {
    ...
    /**
     * 'Simple', 'JSON' or FQDN with {@link com.t1t.apim.core.loggingIApimanLogger} implementation.
     *
